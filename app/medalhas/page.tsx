...
import { medals } from "@/lib/mock-data";
import { players } from "@/lib/mock-data";
import { Card } from "@/components/ui/card";
import { Badge } from "@/components/ui/badge";
import { Trophy, Target, Award, Crown } from "lucide-react";

type Rarity = "todas" | "lendário" | "épico" | "raro" | "comum";
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        ...
        <Card className="p-4 border-border gap-3">
          <div className="flex items-center justify-between mb-2">
            ...
            <div className="text-4xl font-bold">
              {medals.filter((m) => m.rarity === "lendário").length}
            </div>
          </div>
        ...
        <Card className="p-4 border-border gap-3">
          <div className="flex items-center justify-between mb-2">
            ...
            <div className="text-4xl font-bold">
              {medals.filter((m) => m.rarity === "épico").length}
            </div>
          </div>
        ...
        <Card className="p-4 border-border gap-3">
          <div className="flex items-center justify-between mb-2">
            ...
            <div className="text-4xl font-bold">
              {medals.filter((m) => m.rarity === "raro").length}
            </div>
          </div>
